  ...
  return (
    <div className="container">
      ...
      <div className="plus-minus-container">
            ...
            <Image src='/../public/icon-minus.svg' height='8px' width='15px' alt="minus"/>
            </div>
            <div className="count">
            {itemCount}
            </div>
            <div className="plus" onClick={()=>inc()}>
            <Image src='/../public/icon-plus.svg' height='15px' width='15px' alt="plus"/>
            </div>
        </div>
      
      <div className="addcart" onClick={()=>addToCart(product,itemCount)}>
            <Image src='/../public/icon-cart.svg' height='20px' width='20px' alt="cart"/>
            <p>Add to cart</p>
            </div>
      </div>
    </div>
