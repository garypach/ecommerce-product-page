...
const ImageBox = () =>{
    ...
    <div className="image-container">
        <SRLWrapper options={options}>
            <a className="img-desktop" href={`/../public/assests/images/${selectedImage.imageName}`}>
            <Image src={`/../public/assests/images/${selectedImage.imageName}`} height='1000px' width='1000px' alt={`${selectedImage.tag}`}/>
        </a>
        </SRLWrapper>
        ...
        return (
          ...
          >
            {index === current && (
             <Image src={`/../public/assests/images/${slide.imageName}`} height='1000px' width='1000px' alt={`${slide.imageName}`}/>
            )}
          </div>
        );
      })}
...
const TagImage = ({number,handleSetTag,tagActive}) =>{
    return <div className="single"><Image srl_gallery_image="true" className={`tag ${tagActive ? 'active' : null}`} onClick={ () => handleSetTag(number)} src={`/../public/assests/images/image-product-${number + 1 }-thumbnail.jpg`} height='100%' width='1000px' alt="product"/>
            </div>
}
